			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="boxLeftOneWayFlight">
						...
						<div class="departure_time">Departs <?php echo $depart; ?> at: <?php echo $row["departure_time"]; ?></div>
						...
						<div class="arrival_time">Arrives <?php echo $depart; ?> at: <?php echo $row["arrival_time"]; ?></div>
			...
			?>
				...
				<div class="col-sm-12">
					...
					<div class="boxLeftOneWayFlight">
						...
						<div class="departure_time">Departs <?php echo $depart; ?> at: <?php echo $rowOutbound["departure_time"]; ?></div>
						...
						<div class="arrival_time">Arrives <?php echo $depart; ?> at: <?php echo $rowOutbound["arrival_time"]; ?></div>
				...
				<div class="col-sm-12">
						...
						<div class="boxLeftOneWayFlight">
							...
							<div class="departure_time">Departs <?php echo $return; ?> at: <?php echo $rowInbound["departure_time"]; ?></div>
							...
							<div class="arrival_time">Arrives <?php echo $return; ?> at: <?php echo $rowInbound["arrival_time"]; ?></div>
